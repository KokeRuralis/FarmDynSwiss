...
$endif.data
 ...
 table op_attr(operation,machVar,rounded_plotsize,opAttr) "resource requirements of operations"
    ...
    soilSample                .67kw."2"          0.2              1.68          3.6         3.98
    manDist                   .67kw."2"          0.75             6.3         35.50        24.53
    basFert                   .67kw."2"          0.91             7.64        22.55        20.84
*
*   --- page 153, KTBL 2010/2011
*
    plow                      .67kw."2"          1.61           13.55         91.93        71.65
    chiselPlow                .67kw."2"          2.86            24.0         71.83        61.75
    SeedBedCombi              .67kw."2"          0.83             7.0         90.36        66.46
    sowMachine                .67kw."2"          0.61            5.12         43.19        21.88
    directSowMachine          .67kw."2"          0.67             5.6         57.85        34.87
    circHarrowSow             .67kw."2"          1.29            12.9         16.96        27.16
    springTineHarrow          .67kw."2"          0.63            5.32         40.62        23.12
    weedValuation             .67kw."2"          0.16            1.34          2.88         3.18
    herb                      .67kw."2"          0.28            2.35         21.55        11.44
    weederLight               .67kw."2"          0.70            5.91         23.34        18.11
    weederIntens              .67kw."2"          0.80            6.72         38.41        30.22
    plantValuation            .67kw."2"          0.13            1.09          2.34         2.59
    NFert320                  .67kw."2"          1.00            8.40         24.42        22.66
    NFert160                  .67kw."2"          0.19             0.8          1.16         1.58
    lime_fert                 .67kw."2"          0.48             3.6         12.54         6.51
    combineCere               .67kw."2"          0.75            6.31        151.94        50.18
    combineRape               .67kw."2"          0.75            6.31        151.94        50.18
    combineMaiz               .67kw."2"          0.75            6.31        151.94        50.18
    cornTransport             .67kw."2"          0.86            7.20         38.26        24.44
...
*
    stubble_shallow           .67kw."2"          0.84            7.06         37.91        24.06
    stubble_deep              .67kw."2"          0.92             9.8          7.99        18.04
*
*--- KTBL 12/13 S. 420 [TK,24.07.13]
*
    rotaryHarrow              .67kw."2"          1.09            9.13          76.19       38.85
    NminTesting               .67kw."2"          0.51            4.28           9.17       10.15
    mulcher                   .67kw."2"          1.15            9.65          36.97       37.54
    chitting                  .67kw."2"          2.36                         481.82       97.80
    solidManDist              .67kw."2"          2.86           24.00          75.46       90.46
    seedPotatoTransp          .67kw."2"          0.20            1.68          35.12       20.05
    potatoLaying              .67kw."2"          1.67           14.00         154.10       80.77
    rakingHoeing              .67kw."2"          0.25            2.13          20.13        9.05
    earthingUp                .67kw."2"          1.25           10.50          50.99       43.91
    knockOffHaulm             .67kw."2"          1.37           11.51         118.30       62.36
    killingHaulm              .67kw."2"          0.23            1.15           5.48        3.09
    potatoHarvest             .67kw."2"         14.29           55.23         737.60      340.00
    potatoTransport           .67kw."2"          3.00           25.20          56.06       94.80
*
...
*
   singleSeeder               .67kw."2"         0.96           8.08          73.27        37.82
   weederHand                 .67kw."2"        71.52           0.35           1.26         1.09
   uprootBeets                .67kw."2"         4.00          33.60         284.46       270.00

*
*---  KTBL 12/13 S.348  (BL 10.02.2014)
*
   DiAmmonium                 .67kw."2"        1.00            8.40          24.42       22.66
   grinding                   .67kw."2"                                                     84
   disposal                   .67kw."2"         0.7            5.88          20.99       17.07
*---  KTBL 14/15 S.331  (WB 27.07.2016)
*  coveringSilo               .67kw.2ha         4.2                         265.15       60.61
   coveringSilo               .67kw."2"         4.2                                      69.57

*     H?cksler wird bei KTBL nur als Dienstleistung gef?hrt, nicht zur Eigenanschaffung
*
   chopper                    .67kw."2"        1.25           10.50         305.88      131.05
*
*---  KTBL 14/15 S.453 (CP 28.02.2018)
*
*                                               labTime         diesel      fixCost      varCost   nPers  amount
   mowing                     .67Kw."2"         0.26            2.21         32.42         14.67
   tedding                    .67kw."2"         0.36            3.00         15.00         11.14
   raking                     .67kw."2"         0.55            4.59         19.62         14.55
   silageTrailer              .67kw."2"                                                    98.00           11.9
   closeSilo                  .67kw."2"         1.09                         69.42         15.87
   grasReSeeding              .67kw."2"         0.91            7.64         30.83         25.11
   roller                     .67kw."2"         0.33            2.77         29.07          8.67
...
*---  Copied, data not found
   ...
   baleTransportSil           .67kw."2"         0.80            6.75         60.03         29.73           11.9
   baleTransportHay           .67kw."2"         1.22           10.24         91.09         45.12            4.8
;
...
set grasTill(till) /noTill, silo, bales, hay, graz, hayM, grasM/;
